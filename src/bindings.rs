        ...
        pub mod http {
          ...
          pub mod incoming_handler {
            ...
            const _: () = {
              ...
              unsafe extern "C" fn __export_handle(arg0: i32,arg1: i32,) {
                #[allow(unused_imports)]
                use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                ...
                <_GuestImpl as Guest>::handle(super::super::super::super::wasi::http::types::IncomingRequest::from_handle(arg0 as u32), super::super::super::super::wasi::http::types::ResponseOutparam::from_handle(arg1 as u32));
              }
            };
